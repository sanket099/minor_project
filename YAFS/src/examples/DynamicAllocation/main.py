...
def main(simulated_time):
    ...
    pop2 = Statical(number_generators,name="Statical", activation_dist = dDistribution)
    ...
    s2 = Sim(t, default_results_path="Results_%s_singleApp2" % (simulated_time))
    # s2.deploy_app2(app1, placement, pop1, selectorPath1)
    s2.deploy_app2(app2, placement, pop2,  selectorPath2)

    s2.run(simulated_time, test_initial_deploy=False, show_progress_monitor=False)
    # s.draw_allocated_topology() # for debugging
