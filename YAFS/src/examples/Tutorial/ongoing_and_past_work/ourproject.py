...
def create_json_topology():
    ...
    cloud_dev1= {"id": 0, "model": "cloud","mytag":"cloud", "IPT": 5000 * 10 ^ 6, "RAM": 40000,"COST": 30,"WATT":20.0}
    # cloud_dev2 = {"id": 3, "model": "cloud", "mytag": "cloud", "IPT": 5000 * 10 ^ 6, "RAM": 40000, "COST": 10,
    #               "WATT": 20.0}
...
def main(simulated_time):
    ...
    placement.scaleService({"ServiceA": 1, "ServiceB": 1})
