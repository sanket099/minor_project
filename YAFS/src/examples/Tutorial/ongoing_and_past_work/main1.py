...
def create_application():
    ...
    """
    # MODULE SERVICES
    a.add_service_module("ServiceA", m_a, m_b, fractional_selectivity, threshold=1)
...
def create_json_topology():
    ...
    cloud_dev = {"id": 0, "model": "cloud", "mytag": "cloud", "IPT": 5000 * 10 ^ 6, "RAM": 40000, "COST": 3,
                 "WATT": 20.0}
...
def main(simulated_time):
    ...
    stats = Stats("D:/YAFS/YAFS/src/examples\Tutorial\results")
    print("bytes " + str(stats.bytes_transmitted()))
    print("watt " + str(stats.get_watt(simulated_time, t)))
