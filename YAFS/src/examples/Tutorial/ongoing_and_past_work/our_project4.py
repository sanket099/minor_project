...
RANDOM_SEED = 1  # to keep random data constant
...
def create_application():
    ...
    m_b = Message("M.B", "Sensor", "ServiceB", instructions=30 * 10 ^ 6, bytes=500)
    m_c = Message("M.C", "Sensor", "ServiceC", instructions=30 * 10 ^ 6, bytes=500)

    m_a1 = Message("M.D", "ServiceA", "Actuator", instructions=30 * 10 ^ 6, bytes=500)
    m_b1 = Message("M.E", "ServiceB", "Actuator", instructions=30 * 10 ^ 6, bytes=500)
    m_c1 = Message("M.F", "ServiceC", "Actuator", instructions=30 * 10 ^ 6, bytes=500)
    ...
    """
    # MODULE SERVICES
    a.add_service_module("ServiceA", m_a, m_a1, fractional_selectivity, threshold=1)
    a.add_service_module("ServiceB", m_b, m_b1, fractional_selectivity, threshold=1)
    a.add_service_module("ServiceC", m_c, m_c1, fractional_selectivity, threshold=1)
...
def create_json_topology():
    ...
    fog_dev = {"id": 3, "model": "cloud", "mytag": "fog", "IPT": 5000 * 10 ^ 4, "RAM": 10000, "COST": 1,
               "WATT": 10.0}

    cloud_dev = {"id": 4, "model": "cloud", "mytag": "cloud", "IPT": 5000 * 10 ^ 6, "RAM": 40000, "COST": 10,
                 "WATT": 20.0}
    sensor_dev_1 = {"id": 0, "model": "sensor-device", "IPT": 100 * 10 ^ 6, "RAM": 4000, "COST": 3, "WATT": 40.0}
    sensor_dev_2 = {"id": 1, "model": "sensor-device", "IPT": 100 * 10 ^ 6, "RAM": 4000, "COST": 3, "WATT": 40.0}
    sensor_dev_3 = {"id": 2, "model": "sensor-device", "IPT": 100 * 10 ^ 6, "RAM": 4000, "COST": 3, "WATT": 40.0}

    actuator_dev = {"id": 5, "model": "actuator-device", "IPT": 100 * 10 ^ 6, "RAM": 4000, "COST": 3, "WATT": 40.0}

    link1 = {"s": 0, "d": 3, "BW": 1, "PR": 10}
    link2 = {"s": 1, "d": 3, "BW": 1, "PR": 10}
    link3 = {"s": 2, "d": 3, "BW": 1, "PR": 10}

    link4 = {"s": 3, "d": 4, "BW": 1, "PR": 10}
    link5 = {"s": 3, "d": 5, "BW": 1, "PR": 100}

    link6 = {"s": 4, "d": 5, "BW": 1, "PR": 100}
    ...
    topology_json["entity"].append(sensor_dev_3)
...
def main(simulated_time):
    ...
    plt.savefig(folder_results + "graph.png")
    ...
    """
    PLACEMENT algorithm : How to assign module applications to topology
    """
    ...
    pop.set_src_control(
        {"model": "sensor-device", "number": 1, "message": app.get_message("M.B"), "distribution": dDistribution})
    pop.set_src_control(
    ...
    selectorPath = MinimunPath()  # bellman ford #
