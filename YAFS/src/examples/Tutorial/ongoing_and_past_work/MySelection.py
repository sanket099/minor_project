"""
    This algorithm have one obligatory functions:
        *get_path*: It provides the route to follow the message within the topology to reach the destination module,
        it can also be seen as an orchestration algorithm.
"""
import random
import logging
...
class OneRandomPath(MySelection):
    """
...
class First_ShortestPath(MySelection):
