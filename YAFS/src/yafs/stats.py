...
class Stats:
    ...
    def compute_times_df(self):
        ...
        self.df["latency"] = self.df["time_reception"] - self.df["time_emit"]
    ...
    def get_watt(self,totaltime,topology,by=Metrics.WATT_SERVICE):
        ...
        if by == Metrics.WATT_SERVICE:
            ...
            for id_node in nodes.index:
                results[id_node] = {"model": nodeInfo[id_node]["model"],
            ...
            for node_key in nodeInfo:
                ...
                uptime = end-start
                results[node_key] = {"model":nodeInfo[node_key]["model"],"watt":uptime*nodeInfo[node_key]["WATT"],"uptime":uptime}
        print("watt results : : debug : " + str(results))
        return results
